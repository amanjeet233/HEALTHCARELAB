...
```bash
node "D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.augment/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.augment/get-shit-done/references/thinking-models-research.md
...
```bash
node "D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.augment/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
