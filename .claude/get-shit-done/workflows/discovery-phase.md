...
See D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.claude/get-shit-done/templates/discovery.md
...
Use D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.claude/get-shit-done/templates/discovery.md.
