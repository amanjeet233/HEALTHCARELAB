...
```bash
PHASE_INFO=$(node "D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.cursor/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.cursor/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.cursor/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
