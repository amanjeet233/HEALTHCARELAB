...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae
                  → checks D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/get-shit-done
                  → writes to D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/get-shit-done/hooks/
...
@D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
