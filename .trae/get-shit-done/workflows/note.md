...
- **Global scope**: `D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/notes/`)
...
2. Glob `D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/notes/*.md` (if directory exists) — global notes
...
Global (D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.trae/notes/` — works in any directory
