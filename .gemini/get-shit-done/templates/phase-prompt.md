...
<!-- For checkpoint task examples and patterns, see @D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.gemini/get-shit-done/references/checkpoints.md -->
...
See `D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
