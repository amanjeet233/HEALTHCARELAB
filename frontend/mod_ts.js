...
const startIdx = txt.indexOf('<Card');
const endIdx = txt.indexOf('</Card>', startIdx);
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  txt = txt.substring(0, startIdx) + newCard + txt.substring(endIdx);
  fs.writeFileSync('src/pages/TestListingPage.tsx', txt, 'utf-8');
  console.log('Fixed layout via script from file');
} else {
