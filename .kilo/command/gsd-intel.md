...
Intel system is disabled. To activate:
  ...
  node D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.kilo/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.kilo/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.kilo/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.kilo/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.kilo/get-shit-done/bin/gsd-tools.cjs
