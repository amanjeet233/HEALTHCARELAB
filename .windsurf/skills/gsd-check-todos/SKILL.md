...
<execution_context>
@D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.windsurf/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@D:/CU/SEM 6/SEM6PP/HEALTHCARELAB/.windsurf/get-shit-done/workflows/check-todos.md`.
